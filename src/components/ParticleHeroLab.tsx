 ...
 */
const ParticleLogoLab = dynamic(
  () => import("./three/ParticleLogoLab").then((m) => m.ParticleLogoLab),
...
export function ParticleHeroLab() {
  ...
  return (
    ...
    >
      ...
      <ParticleLogoLab className="absolute inset-0 h-full w-full" />
...
export default ParticleHeroLab;
