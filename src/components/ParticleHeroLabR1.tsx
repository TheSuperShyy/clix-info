...
/**
 * ParticleHeroLab — lab-only hero hosting the experimental shape-morphing,
 * RGB particle mark (expand-in intro → logo → circle → square → triangle → …).
 * Sticky-pinned so content can slide over it, like the real hero.
 *
 ...
 */
const ParticleLogoLabR1 = dynamic(
  () => import("./three/ParticleLogoLabR1").then((m) => m.ParticleLogoLabR1),
...
export function ParticleHeroLabR1() {
  ...
  return (
    ...
    >
      ...
      <ParticleLogoLabR1 className="absolute inset-0 h-full w-full" />
...
export default ParticleHeroLabR1;
