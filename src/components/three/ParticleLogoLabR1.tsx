...
/* ────────────────────────────────────────────────────────────────────────────
 * ParticleLogoLab — experimental hero (lab only).
 *
...
export function ParticleLogoLabR1({ className = "" }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    const INTRO_DELAY = 2.7; // hold the mark hidden until the hero text + CTA finish rendering (see ParticleHeroLab timing)
...
export default ParticleLogoLabR1;
